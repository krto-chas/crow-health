...
def test_profile_groups_dated_json_files(tmp_path: Path) -> None:
    ...
    with zipfile.ZipFile(archive, "w") as zf:
        zf.writestr("DI/a/2026-01-01_2026-02-01_1_sleepData.json", '[{"calendarDate":"2026-01-01","score":1}]')
        zf.writestr("DI/a/2026-02-01_2026-03-01_1_sleepData.json", '[{"calendarDate":"2026-02-01","score":2}]')
